...
<section {{ $attributes->merge([
  ...
  <div class="bg-brand text-white -mb-[120px] pb-[120px] md:bg-transparent md:text-inherit md:m-0 md:p-0">
    <h2 class="title flex items-center justify-between pl-[5vw] pt-9 gap-x-4 mb-5 md:p-0">
      ...
      <a class="text-[15px] min-h-8 pl-4 py-2 !pr-[5vw] button !rounded-r-none md:!pr-4 md:text-white md:bg-brand md:!rounded-r-full md:hover:text-brand md:hover:border-brand" href="{{ route('doctors') }}">
  ...
  <div class="relative doctors-swiper mb-8 sm:max-w-[584px] px-[48px] sm:mx-auto md:mb-0 md:max-w-full md:p-0">
    <div class="swiper">
